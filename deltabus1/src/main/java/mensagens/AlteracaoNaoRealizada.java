...
public class AlteracaoNaoRealizada extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AlteracaoNaoRealizada(String mensagem) {
		...
		JLabel lblNewLabel_1 = new JLabel("Você não realizou nenhuma alteração!");
		lblNewLabel_1.setForeground(new Color(255, 255, 255));
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_1.setBounds(44, 52, 249, 31);
