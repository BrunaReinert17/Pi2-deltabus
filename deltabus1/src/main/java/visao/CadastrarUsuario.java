...
public class CadastrarUsuario extends JPanel {
	...
	private JButton btnConfirmar;
		...
		public CadastrarUsuario() {
			...
			JLabel lblCpdf = new JLabel("CPF:");
			lblCpdf.setFont(new Font("Dialog", Font.BOLD, 14));
			lblCpdf.setBounds(81, 169, 46, 14);
			add(lblCpdf);
			
			textField_2 = new JTextField();
			textField_2.setBackground(new Color(255, 255, 255));
			textField_2.setForeground(new Color(245, 245, 245));
			textField_2.setColumns(10);
			textField_2.setBounds(81, 188, 174, 23);
			add(textField_2);
